...
1. [Persona Effect — James Lester research on animated pedagogical agents](https://en.wikipedia.org/wiki/Pedagogical_agent)
2. [Statistics Course — Sylvia the Squirrel FAQ](https://dmccreary.github.io/statistics-course/faq/#who-is-sylvia-the-squirrel)
3. [Statistics Course CSS](https://github.com/dmccreary/statistics-course/blob/main/docs/css/extra.css)
4. [Statistics Course JavaScript](https://github.com/dmccreary/statistics-course/blob/main/docs/js/extra.js)
5. [Statistics Course CLAUDE.md](https://github.com/dmccreary/statistics-course/blob/main/CLAUDE.md)
