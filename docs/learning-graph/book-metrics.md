...
| 7 | Glossary Terms | 50 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 86,479 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 1 | 0 | H4 headers starting with '#### Diagram:' |
| Equations | 100 | 0 | LaTeX expressions (inline and display) |
| Total Words | 86,479 | 0 | Words in markdown files |
| Links | 848 | 0 | Hyperlinks in markdown format |
| Equivalent Pages | 361 | 15 | Estimated pages (250 words/page + visuals) |
