...
This interactive viewer lets you explore the learning graph for *Building Intelligent Textbooks* — 150 concepts and their 180 dependencies, drawn from the data in the [learning-graph](../learning-graph/index.md) MicroSim. The graph renders on an aliceblue canvas so it stays legible when embedded on a dark background.
...
[Open Graph Viewer Fullscreen](./main.html){ .md-button .md-button--primary }
