...
**MicroSim:** high-school-courses
**Repository:** intelligent-textbooks
...
- **Detected subjects:** Mathematics, Physics, Computer Science, Chemistry, Biology, Statistics, Engineering, Economics
- **Visualization types:** simulation, graph, interactive-demo, network, timeline, map
- **Has main.html:** Yes
- **Has index.md:** Yes
