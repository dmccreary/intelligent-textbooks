#!/bin/bash
# Build script for Self-Improving Intelligent Textbooks ArXiv Paper
...
echo "Building Self-Improving Intelligent Textbooks Paper..."
echo "======================================================="
echo ""
...
if [ -f "main.pdf" ]; then
    ...
    if [ "$ARXIV_PACKAGE" == "true" ]; then
        ...
        # Create zip with all LaTeX source files
