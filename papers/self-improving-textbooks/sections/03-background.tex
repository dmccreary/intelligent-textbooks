...
\textit{five-level framework}, in which each level adds capability:
...
4 & Generated content & AI-authored explanations and simulations \\
...
This paper is fundamentally concerned with the transition from Level~4 to
Level~5---the point at which the textbook begins to improve its own content
based on evidence.
